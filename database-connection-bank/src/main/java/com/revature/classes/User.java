...
public class User {
	...
	public static void main(String[] args) {
		...
		if (num == 1) {
			...
			// checks if username already exists and creates a request for account creation
		...
		if (num == 2) {
			...
			while (temp) {
				...
				case 2:
					...
					if (withdraw < 0) {
						LOG.error("Attempted negative withdraw");
				...
				case 4:
					...
					// log entry is done within DAO since DAO reuses deposit and withdraw methods
					// (prevents creation of deposit
